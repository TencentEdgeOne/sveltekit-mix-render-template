...
<svelte:head>
	<title>Sverdle - SvelteKit Hybrid Rendering Template</title>
	<meta name="description" content="A Wordle clone demonstrating SvelteKit's data loading, form handling, and progressive enhancement" />
</svelte:head>
